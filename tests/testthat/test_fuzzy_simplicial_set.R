...
res <- fuzzy_simplicial_set(iris10, n_neighbors = 4, set_op_mix_ratio = 1, local_connectivity = 1,
                            bandwidth = 1, nn_method = "fnn", verbose = FALSE, n_threads = 0)
...
# Union + bandwidth
res <- fuzzy_simplicial_set(iris10, n_neighbors = 4, set_op_mix_ratio = 1, local_connectivity = 1,
                            bandwidth = 0.5, nn_method = "fnn", verbose = FALSE, n_threads = 0)
...
# matrix
res <- fuzzy_simplicial_set(iris10, n_neighbors = 4, set_op_mix_ratio = 1, local_connectivity = 1,
                            bandwidth = 1, nn_method = "fnn", verbose = FALSE, n_threads = 1)
expect_equal(res, V_union, tol = 1e-4)
...
# Union + bandwidth
res <- fuzzy_simplicial_set(iris10, n_neighbors = 4, set_op_mix_ratio = 1, local_connectivity = 1,
                            bandwidth = 0.5, nn_method = "fnn", verbose = FALSE, n_threads = 1)
expect_equal(res, V_union_bandwidth, tol = 1e-4)
