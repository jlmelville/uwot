...
sparr <- new("dgCMatrix",
             ...
             x = c(0.918390745913514, 0.215686070576616, 1.40710203887692,
                   0.163188411813119, 0.434165332563817, 0.704001636268765,
                   0.0323220081795518), factors = list())

sparr2 <- new("dgCMatrix", i = c(0L, 1L, 2L, 1L, 2L, 0L, 1L),
              p = c(0L, 3L, 5L, 7L),
              Dim = c(3L, 3L), Dimnames = list(NULL, NULL),
              x = c(1.68463092, 2.91620546, 0.26469792,
...
res09 <- matrix(c(1.66877087146, 0.137467853888, 1.40799953091,
...
res01 <- matrix(c(0.97318335824, 1.12392924757, 0.734457833761,
