...
annoy_euclidean_nns <- function(index_name, nrow, ncol, n, search_k, grain_size = 1L, verbose = FALSE) {
    .Call(`_uwot_annoy_euclidean_nns`, index_name, nrow, ncol, n, search_k, grain_size, verbose)
}

annoy_cosine_nns <- function(index_name, nrow, ncol, n, search_k, grain_size = 1L, verbose = FALSE) {
    .Call(`_uwot_annoy_cosine_nns`, index_name, nrow, ncol, n, search_k, grain_size, verbose)
}

annoy_manhattan_nns <- function(index_name, nrow, ncol, n, search_k, grain_size = 1L, verbose = FALSE) {
    .Call(`_uwot_annoy_manhattan_nns`, index_name, nrow, ncol, n, search_k, grain_size, verbose)
}
