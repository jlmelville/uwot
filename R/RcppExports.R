...
calc_row_probabilities_parallel <- function(nn_dist, perplexity, n_iter = 200L, tol = 1e-5, ret_sigma = FALSE, n_threads = 0L, grain_size = 1L) {
    .Call(`_uwot_calc_row_probabilities_parallel`, nn_dist, perplexity, n_iter, tol, ret_sigma, n_threads, grain_size)
}
