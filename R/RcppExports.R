...
optimize_layout_r <- function(head_embedding, tail_embedding, positive_head, positive_tail, n_epochs, n_vertices, epochs_per_sample, method, method_args, initial_alpha, negative_sample_rate, pcg_rand = TRUE, n_threads = 0L, grain_size = 1L, move_other = TRUE, verbose = FALSE) {
    .Call(`_uwot_optimize_layout_r`, head_embedding, tail_embedding, positive_head, positive_tail, n_epochs, n_vertices, epochs_per_sample, method, method_args, initial_alpha, negative_sample_rate, pcg_rand, n_threads, grain_size, move_other, verbose)
}
