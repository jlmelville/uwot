...
* Top left: the UMAP results colored by the typical label for that dataset.
...
Next up are (mostly) more real world datasets.
...
This is the 20 Newsgroups data, from which I manually generated a 3000D PCA result.
