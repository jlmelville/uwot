...
| spca                        | agspectral                |
:----------------------------:|:--------------------------:
![iris spca](img/init/iris-spca.png)|![iris agspectral](img/init/iris-agspectral.png)

### s1k

| spca                        | agspectral                |
:----------------------------:|:--------------------------:
![s1k spca](img/init/s1k-spca.png)|![s1k agspectral](img/init/s1k-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![olivetti spca](img/init/olivetti-spca.png)|![olivetti agspectral](img/init/olivetti-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![frey spca](img/init/frey-spca.png)|![frey agspectral](img/init/frey-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![coil20 spca](img/init/coil20-spca.png)|![coil20 agspectral](img/init/coil20-agspectral.png)

### coil100

|                             |                           |
:----------------------------:|:--------------------------:
![coil100 spca](img/init/coil100-spca.png)|![coil100 agspectral](img/init/coil100-agspectral.png)

### mnist

|                             |                           |
:----------------------------:|:--------------------------:
![mnist spca](img/init/mnist-spca.png)|![mnist agspectral](img/init/mnist-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![fashion spca](img/init/fashion-spca.png)|![fashion agspectral](img/init/fashion-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![kuzushiji spca](img/init/kuzushiji-spca.png)|![kuzushiji agspectral](img/init/kuzushiji-agspectral.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![norb spca](img/init/norb-spca.png)|![norb agspectral](img/init/norb-agspectral.png)

### tasic2018

|                             |                           |
:----------------------------:|:--------------------------:
![tasic2018 spca](img/init/tasic2018-spca.png)|![tasic2018 agspectral](img/init/tasic2018-agspectral.png)

### macosko2015

|                             |                           |
:----------------------------:|:--------------------------:
![macosko2015 spca](img/init/macosko2015-spca.png)|![macosko2015 agspectral](img/init/macosko2015-agspectral.png)
![macosko2015 spectral](img/init/macosko2015-spectral.png)|![macosko2015 laplacian](img/init/macosko2015-laplacian.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![iris spca1e-2](img/init/iris_spca1e-2.png)|![iris spca1](img/init/iris-spca1.png)

### s1k

|                             |                           |
:----------------------------:|:--------------------------:
![s1k spca1e-2](img/init/s1k_spca1e-2.png)|![s1k spca1](img/init/s1k-spca1.png)

### olivetti

|                             |                           |
:----------------------------:|:--------------------------:
![olivetti spca1e-2](img/init/oli_spca1e-2.png)|![olivetti spca1](img/init/olivetti-spca1.png)

### frey

|                             |                           |
:----------------------------:|:--------------------------:
![frey spca1e-2](img/init/frey_spca1e-2.png)|![frey spca1](img/init/frey-spca1.png)

### coil20

|                             |                           |
:----------------------------:|:--------------------------:
![coil20 spca1e-2](img/init/coil20_spca1e-2.png)|![coil20 spca1](img/init/coil20-spca1.png)

### coil100

|                             |                           |
:----------------------------:|:--------------------------:
![coil100 spca1e-2](img/init/coil100_spca1e-2.png)|![coil100 spca1](img/init/coil100-spca1.png)

### mnist

|                             |                           |
:----------------------------:|:--------------------------:
![mnist spca1e-2](img/init/mnist_spca1e-2.png)|![mnist spca1](img/init/mnist-spca1.png)

### fashion

|                             |                           |
:----------------------------:|:--------------------------:
![fashion spca1e-2](img/init/fashion_spca1e-2.png)|![fashion spca1](img/init/fashion-spca1.png)

### kuzushiji

|                             |                           |
:----------------------------:|:--------------------------:
![kuzushiji spca1e-2](img/init/kuzushiji_spca1e-2.png)|![kuzushiji spca1](img/init/kuzushiji-spca1.png)

### norb

|                             |                           |
:----------------------------:|:--------------------------:
![norb spca1e-2](img/init/norb_spca1e-2.png)|![norb spca1](img/init/norb-spca1.png)

### tasic2018

|                             |                           |
:----------------------------:|:--------------------------:
![tasic2018 spca1e-2](img/init/tasic2018_spca1e-2.png)|![tasic2018 spca1](img/init/tasic2018-spca1.png)

### macosko2015

|                             |                           |
:----------------------------:|:--------------------------:
![macosko2015 spca1e-2](img/init/macosko2015_spca1e-2.png)|![macosko2015 spca1](img/init/macosko2015-spca1.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![iris rand1337](img/init/iris-rand1337.png)|![iris rand2](img/init/iris-rand2.png)

### s1k

|                             |                           |
:----------------------------:|:--------------------------:
![s1k rand1337](img/init/s1k-rand1337.png)|![s1k rand2](img/init/s1k-rand2.png)

### olivetti

|                             |                           |
:----------------------------:|:--------------------------:
![olivetti rand1337](img/init/olivetti-rand1337.png)|![olivetti rand2](img/init/olivetti-rand2.png)

### frey

|                             |                           |
:----------------------------:|:--------------------------:
![frey rand1337](img/init/frey-rand1337.png)|![frey rand2](img/init/frey-rand2.png)

### coil20

|                             |                           |
:----------------------------:|:--------------------------:
![coil20 rand1337](img/init/coil20-rand1337.png)|![coil20 rand2](img/init/coil20-rand2.png)

### coil100

|                             |                           |
:----------------------------:|:--------------------------:
![coil100 rand1337](img/init/coil100-rand1337.png)|![coil100 rand2](img/init/coil100-rand2.png)

### mnist

|                             |                           |
:----------------------------:|:--------------------------:
![mnist rand1337](img/init/mnist-rand1337.png)|![mnist rand2](img/init/mnist-rand2.png)

### fashion

|                             |                           |
:----------------------------:|:--------------------------:
![fashion rand1337](img/init/fashion-rand1337.png)|![fashion rand2](img/init/fashion-rand2.png)

### kuzushiji

|                             |                           |
:----------------------------:|:--------------------------:
![kuzushiji rand1337](img/init/kuzushiji-rand1337.png)|![kuzushiji rand2](img/init/kuzushiji-rand2.png)

### norb

|                             |                           |
:----------------------------:|:--------------------------:
![norb rand1337](img/init/norb-rand1337.png)|![norb rand2](img/init/norb-rand2.png)

### tasic2018

|                             |                           |
:----------------------------:|:--------------------------:
![tasic2018 rand1337](img/init/tasic2018-rand1337.png)|![tasic2018 rand2](img/init/tasic2018-rand2.png)

### macosko2015

|                             |                           |
:----------------------------:|:--------------------------:
![macosko2015 rand1337](img/init/macosko2015-rand1337.png)|![macosko2015 rand2](img/init/macosko2015-rand2.png)
...
|                             |                           |
:----------------------------:|:--------------------------:
![iris lvrand1337](img/init/iris-lvrand1337.png)|![iris lvrand2](img/init/iris-lvrand2.png)

### s1k

|                             |                           |
:----------------------------:|:--------------------------:
![s1k lvrand1337](img/init/s1k-lvrand1337.png)|![s1k lvrand2](img/init/s1k-lvrand2.png)

### olivetti

|                             |                           |
:----------------------------:|:--------------------------:
![olivetti lvrand1337](img/init/olivetti-lvrand1337.png)|![olivetti lvrand2](img/init/olivetti-lvrand2.png)

### frey

|                             |                           |
:----------------------------:|:--------------------------:
![frey lvrand1337](img/init/frey-lvrand1337.png)|![frey lvrand2](img/init/frey-lvrand2.png)

### coil20

|                             |                           |
:----------------------------:|:--------------------------:
![coil20 lvrand1337](img/init/coil20-lvrand1337.png)|![coil20 lvrand2](img/init/coil20-lvrand2.png)

### coil100

|                             |                           |
:----------------------------:|:--------------------------:
![coil100 lvrand1337](img/init/coil100-lvrand1337.png)|![coil100 lvrand2](img/init/coil100-lvrand2.png)

### mnist

|                             |                           |
:----------------------------:|:--------------------------:
![mnist lvrand1337](img/init/mnist-lvrand1337.png)|![mnist lvrand2](img/init/mnist-lvrand2.png)

### fashion

|                             |                           |
:----------------------------:|:--------------------------:
![fashion lvrand1337](img/init/fashion-lvrand1337.png)|![fashion lvrand2](img/init/fashion-lvrand2.png)

### kuzushiji

|                             |                           |
:----------------------------:|:--------------------------:
![kuzushiji lvrand1337](img/init/kuzushiji-lvrand1337.png)|![kuzushiji lvrand2](img/init/kuzushiji-lvrand2.png)

### norb

|                             |                           |
:----------------------------:|:--------------------------:
![norb lvrand1337](img/init/norb-lvrand1337.png)|![norb lvrand2](img/init/norb-lvrand2.png)

### tasic2018

|                             |                           |
:----------------------------:|:--------------------------:
![tasic2018 lvrand1337](img/init/tasic2018-lvrand1337.png)|![tasic2018 lvrand2](img/init/tasic2018-lvrand2.png)

### macosko2015

|                             |                           |
:----------------------------:|:--------------------------:
![macosko2015 lvrand1337](img/init/macosko2015-lvrand1337.png)|![macosko2015 lvrand2](img/init/macosko2015-lvrand2.png)
