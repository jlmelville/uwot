...
[Changelog](https://jlmelville.github.io/uwot/news/index.html) for fuller 
details.

*August 29 2026* `uwot` version 0.2.5 has been released to CRAN. This is to 
apply fixes for some minor issues surfaced by CRAN checks (some transitive 
headers in the C++ code for clang, a deprecation in test code) but there are
...
*June 28 2023* Version 0.1.16 has been released to CRAN. This is a very minor
tweak to 0.1.15 to further support the new release of 
...
[umappp C++ library](https://github.com/libscran/umappp). See `NEWS.md` for
other changes.
