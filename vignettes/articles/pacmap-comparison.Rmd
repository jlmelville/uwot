---
title: "PaCMAP Comparison"
subtitle: Making UMAP behave (more) like PaCMAP
---
...
which was very useful. See the 
[examples article](https://jlmelville.github.io/uwot/articles/umap-examples.html) 
for more details on the datasets.

One extra dataset that we will also look at is `curve2d`,  a simple 2D curve. 
This is used as an example in the paper of how even if you start with the
original coordinates scaled by a constant, dimensionality reduction methods
will, rather than do nothing, still distort the overall shape. Python code to
generate the curve is at
